...
<t:layout_d>
    <input type="text" id="delete" value="${sessionScope.recordDelete}">
    <c:remove var="recordDelete" scope="session" /> 
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer ">
                                <div class="d-flex justify-content-between">
                                    <a href="prescription?uid=${user.id}" class="btn btn-primary">Print</a>
                                    <span>Updated on : ${patient.updatedOn}</span>
                                </div>
                            </div>
                        </div>
                        <div class="records">
                                    ...
                                    <c:forEach items="${records}" var="r">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href='delete-record?rid=<c:out value="${r.id}"></c:out>&pid=<c:out value="${patient.id}"></c:out>&uid=<c:out value="${user.id}"></c:out>' class="btn btn-danger">
                                                        Delete
                                                </a>
                                            </td>
                                        </tr>
    ...
    <script>
        let d = document.getElementById("delete").value;
        if(d === "ok") {
            swal("Success", "Record deleted successfully", "success");
        }
        if(d === "fail") {
            swal("Error", "Record failed to delete", "error");
        }
    </script>
</t:layout_d>