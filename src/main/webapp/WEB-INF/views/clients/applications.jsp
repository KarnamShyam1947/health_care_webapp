        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Client Applications</h1>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Client Applications</h3>
                                    ...
                                    <tbody>
                                        <c:forEach items="${applications}" var="a" varStatus="i">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="client-action?accept=ok&cid=<c:out value='${a.id}'></c:out>"
                                                        class="btn btn-success">Approve</a>

                                                    <a href="client-action?reject=ok&cid=<c:out value='${a.id}'></c:out>"
